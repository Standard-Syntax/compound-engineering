...
1. Read the plan file from `.context/compound-engineering/plan/`. Find the task that was just completed.

2. Read the work session output to determine:
...
4. Write a calibration record to `.context/compound-engineering/calibrations/YYYY-MM-DD-<task-slug>.md` using this template:
...
5. If the actual iteration count exceeded the estimate by 2 or more, append:
