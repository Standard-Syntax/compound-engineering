---
name: ce-research-beta
description: "[BETA] Conduct standalone codebase research producing a compacted, reusable artifact. Use when starting a new feature, investigating an architectural question, or before planning a non-trivial change."
...
```
/ce:research-beta [feature description, bug, or architectural question]
```

**Examples:**
```
/ce:research-beta How does the existing auth system work?
/ce:research-beta Background job processing patterns in ce_engine
/ce:research-beta Adding a new compound-engineering skill — what conventions apply?
```
